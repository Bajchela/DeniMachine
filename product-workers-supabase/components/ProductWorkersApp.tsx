...
const ui = {
  sr: {
    ...
    setupText: 'Dodaj NEXT_PUBLIC_SUPABASE_URL i NEXT_PUBLIC_SUPABASE_ANON_KEY u .env.local ili na Vercel-u.',
  ...
  de: {
    ...
    setupText: 'Füge NEXT_PUBLIC_SUPABASE_URL und NEXT_PUBLIC_SUPABASE_ANON_KEY in .env.local oder in Vercel hinzu.',
